...
PERMISSIONS: Dict[str, Set[Role]] = {
    ...
    "cases:read": {Role.ADMIN, Role.ANALYST},
    "cases:write": {Role.ADMIN, Role.ANALYST},
    "playbook:trigger": {Role.ADMIN, Role.ANALYST},
    "audit:verify": {Role.ADMIN, Role.ANALYST},
    "sessions:manage": {Role.ADMIN},
    "approvals:manage": {Role.ADMIN},
    "quarantine:manage": {Role.ADMIN, Role.ANALYST},
}
